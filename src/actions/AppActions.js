...
export default {
  receiveContacts: () => {
    ContactsAPI
      .getContacts('//jsonplaceholder.typicode.com/users')
      .then(contacts => {
  ...
  saveContact: (contact) => {
    ContactsAPI
      .saveContact('//jsonplaceholder.typicode.com/users', contact)
      .then(contact => {
        AppDispatcher.dispatch({
  ...
  deleteContact: (id) => {
    ContactsAPI
      .deleteContact('//jsonplaceholder.typicode.com/users/'+id)
      .then(contact => {
        AppDispatcher.dispatch({
